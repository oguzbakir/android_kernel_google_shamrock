...
export DEFCONFIG=lineageos_shamrock_defconfig
echo -e "\e[94mSetting bzImage Location For FTL-Kernel By oguzbakir Of XDA\e[0m"
export BZIMAGE=arch/arm/boot/zImage-dtb
...
cd KernelZip/
rm -rf zImage-dtb *.zip
sleep $SLEEP
echo -e "\e[31mCopying bzImage\e[0m"
mv ../arch/arm/boot/zImage-dtb zImage-dtb
sleep $SLEEP
